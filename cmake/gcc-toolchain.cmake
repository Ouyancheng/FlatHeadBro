...
set(TARGET_ARCH "rv64g")
# g = generic gv0p7 = g + vector 0.7 
...
set(C_FLAGS_COMMON                  "-march=${TARGET_ARCH} -mabi=lp64d -mcmodel=${CODE_MODEL} -fno-stack-protector -Wall -nostdlib -ffreestanding -Werror -Wno-unused-function -Wno-unused-variable")
...
set(CMAKE_CXX_FLAGS                 "-Og ${C_FLAGS_COMMON} -std=gnu++11 -fno-exceptions -fno-unwind-tables -fno-rtti")
set(CMAKE_CXX_FLAGS_RELEASE         "-Os -DNDEBUG ${C_FLAGS_COMMON} -std=gnu++11 -fno-exceptions -fno-unwind-tables -fno-rtti")
set(CMAKE_ASM_FLAGS                 "-march=${TARGET_ARCH} -nostdlib -ffreestanding -Wa,--fatal-warnings ")
