...
# seems like relaxation works on clang-15/ld.lld? we will add back -mno-relax if clang's version is less than 15 in CMakeLists.txt
set(C_FLAGS_COMMON                  "-march=${TARGET_ARCH} ${FPIC} --target=${TARGET_TRIPLET} -mabi=lp64d -mcmodel=${CODE_MODEL} -fno-stack-protector -Wall -nostdlib -ffreestanding -Werror -Wno-unused-function -Wno-unused-variable") 
...
set(CMAKE_ASM_FLAGS                 "-march=${TARGET_ARCH} ${FPIC} --target=${TARGET_TRIPLET} -mabi=lp64d -mcmodel=${CODE_MODEL} -nostdlib -ffreestanding -Wa,--fatal-warnings ") 
